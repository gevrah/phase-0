...
//   I had trouble passing the .children property test. Due to a misplaced curly bracket, the property
//    name and values weren't successfully being assigned. After fiddling with it and placing the curly
//     brackets in the right place, the tests passed.

// • How difficult was it to add and delete properties outside of the object itself?
//   It wasn't very tough at all once I figured out the correct method for deleting and the general syntax!

// • What did you learn about manipulating objects in this challenge?
//   I learned the syntax to manipulate (add, change, delete) values and properties from outside objects. 
